...
| Admin gudang | Mengelola master barang, lokasi, pengguna, dan koreksi stok. |
| Pimpinan/pengecek | Melihat stok dan riwayat tanpa boleh mengubah data. |

MVP dapat mulai dari satu peran: `petugas gudang`. Peran lain ditambahkan saat autentikasi tersedia.
